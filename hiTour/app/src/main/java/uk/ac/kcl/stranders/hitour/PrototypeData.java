...
public class PrototypeData {
    ...
    public static Cursor getCursor() {
        ...
        cursor.addRow(new Object[] { 3, "Computed tomography", "Computed tomography (CT) is a diagnostic imaging test used to create detailed images of internal organs, bones, soft tissue and blood vessels.", R.drawable.ctscan});
        cursor.addRow(new Object[] { 4, "Ultrasound scan", "An ultrasound scan, sometimes called a sonogram, is a procedure that uses high-frequency sound waves to create an image of part of the inside of the body.", R.drawable.ultrasound});
